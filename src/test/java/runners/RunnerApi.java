...
@CucumberOptions(
        ...
        tags = "@api2", // testin basina istedigimiz tag ismini verebiliriz. tag sayesinde istedigimiz feature'i veye featuresleri calistirabiliriz.

        dryRun = false // eksik adimlari gormek istedigimizde true yapariz. Diger turlu hep false'da calisacakecho "# API_Cucumber" >> README.md
)


public class RunnerApi {
    /*
    Runners dosyasi bizim testlerimizi toplu bir sekilde calistirmamizi saglayan bir classtir
      Runners classinin en buyuk ozelligi;
    runner classi bos olur ancak uzerindeki iki notasyonun icerigi doludur.
